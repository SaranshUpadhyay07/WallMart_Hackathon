                ...
                {recycleOpen && (
                  <div className="absolute left-0 mt-2 w-56 bg-white border border-green-200 rounded-xl shadow-lg z-50 flex flex-col">
                    <button
                      ...
                      onClick={() => { setRecycleOpen(false); window.dispatchEvent(new CustomEvent('openAdminLogin')); }}
                    >Login as Admin</button>
                    <button
                      className="px-4 py-2 text-left hover:bg-green-50"
                      onClick={() => { setRecycleOpen(false); window.dispatchEvent(new CustomEvent('openUserLogin')); }}
                    >Login as User</button>
                    <button
                      className="px-4 py-2 text-left hover:bg-green-50 rounded-b-xl"
                      onClick={() => { setRecycleOpen(false); window.dispatchEvent(new CustomEvent('openUserRegister')); }}
